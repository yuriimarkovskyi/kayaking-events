  ...
  initialState: {
    events: [
      ...
      },
      {
        ...
        description: '🤗 Друзі, запрошуємо вас на сплав, що проходить у самому центрі нашого з вами улюбленого міста! Якщо ви новенький у місті або хочете побачити його з нової точки зору, цей сплав саме для вас!',
      ...
      },
      {
        ...
        description: '🤗 Друзі, запрошуємо вас на сплав, що проходить у самому центрі нашого з вами улюбленого міста! Якщо ви новенький у місті або хочете побачити його з нової точки зору, цей сплав саме для вас!',
        image: `${path}/images/primary/sercem-kyjeva.jpg`,
        dates: [1651923362000, 1654601762000],
        priceSoloKayak: 730,
        priceDoubleKayak: 570,
        images: [
          `${path}/images/secondary/IMG_7989.jpg`,
