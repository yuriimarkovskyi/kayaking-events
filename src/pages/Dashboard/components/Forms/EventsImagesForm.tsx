...
function EventsImagesForm({ closeDrawer }: Props) {
  ...
  return (
    ...
    >
      ...
      {/*     { */}
      {/*       required: true, */}
      {/*       messageSuccess: 'Необхідно завантажити обкладинку', */}
      {/*     }, */}
      {/*   ]} */}
      {/* > */}
      {/*   <Upload */}
      ...
      {/*         messageSuccess.error('Завантажте зображення з коректним розширенням'); */}

      {/*         return Upload.LIST_IGNORE; */}
      {/*       } */}
      {/*       const maxFileSize = file.size / 1024 / 1024 < 2; */}
      {/*       if (!maxFileSize) { */}
      {/*         messageSuccess.error('Розмір файлу не може бути більше 2 мб'); */}
